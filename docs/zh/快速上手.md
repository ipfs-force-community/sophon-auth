...
# res
Add user success: b0c56f24-22e7-431d-a26a-576accd0ebdc, next can add miner for this user
```
...
NAME:
   venus-auth user list - User list
...
OPTIONS:
   ...
   --state value  0:disabled, 1:enabled, not-set:[show all] (default: 0)
   --help, -h     show help (default: false)
...
state: enabled
miners: [f01332]
createTime: Wed, 08 Jun 2022 16:16:20 CST
updateTime: Wed, 08 Jun 2022 16:16:20 CST

number: 2
name: test-user01
state: enabled
createTime: Thu, 25 Aug 2022 17:09:37 CST
updateTime: Thu, 25 Aug 2022 17:09:37 CST
```
...
OPTIONS:
   --name value     
   --comment value  
   --state value    0:disabled, 1:enabled (default: 0)
   --help, -h       show help (default: false)

./venus-auth user update --name=test-user01 --state=1 --comment="test"
